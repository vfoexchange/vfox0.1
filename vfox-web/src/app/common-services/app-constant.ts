export class Configuration {
    ...
    public restrictedPageForADVISOR: string[] =  ['/dashboard/','/dashboard/selectservices','/dashboard/service','/dashboard/maintainwebsite/addclient','/dashboard/comingsoon', '/dashboard/maintainwebsite/addpersonalize',  '/dashboard/maintainwebsite/viewpersonalize', '/dashboard/maintainwebsite/selectprovider', '/dashboard/maintainwebsite/editpersonalize', '/dashboard/profile/changepassword'];
