...
INSERT INTO vfox.ServiceProvider (ServiceId, Name, ShortDesc, LongDesc, Logo, RedirectUrl, CreatedBy, CreatedAt, UpdatedBy, UpdatedAt) VALUES(
7, 'South Dakota Trust Company', 'Serving Families in Perpetuity',  'Our Philosophy: Provide unparalleled trust services delivering value to the client. No investment and/or insurance products – no conflict. Design trust products and services by listening to our clients. Customized trust services (not cookie cutter). Continually upgrading services to maintain market edge. Remain a top rated trust, asset protection, privacy and tax jurisdiction.', null, 'http://www.sdtrustco.com/', 1, now(), 1, now());
INSERT INTO vfox.ServiceProvider (ServiceId, Name, ShortDesc, LongDesc, Logo, RedirectUrl, CreatedBy, CreatedAt, UpdatedBy, UpdatedAt) VALUES(
3, 'Capital Group', 'For more than 80 years, we have put investors first.', 'The Capital Advantage: Since 1931, Capital Group has been singularly focused on delivering superior, consistent results for long-term investors using high-conviction portfolios, rigorous research and individual accountability.', null, 'http://www.capitalgroup.com/', 1, now(), 1, now());
INSERT INTO vfox.ServiceProvider (ServiceId, Name, ShortDesc, LongDesc, Logo, RedirectUrl, CreatedBy, CreatedAt, UpdatedBy, UpdatedAt) VALUES(
11, 'Kalicki Collier', 'Your Trusted Nevada Law Firm', 'Kalicki Collier is located in Reno, Nevada, and is a full-service law firm focusing on estate planning, family law, tax planning, real estate development, business planning, probate, business transactions, mergers and acquisitions, bankruptcy, trademark and patents, trust administration and litigation.', null, 'https://kalickicollier.com/', 1, now(), 1, now());